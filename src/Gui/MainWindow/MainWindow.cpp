...
const char COMMUNITY_FORUM_URL[] = "http://stardustcoin.xyz";
const char REPORT_ISSUE_URL[] = "http://stardustcoin.xyz";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("StardustCoin Wallet %1").arg(Settings::instance().getVersion()));
