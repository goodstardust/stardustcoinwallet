...
public:
    ...
    QAction *m_aboutStardustCoinAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/stardustcoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutStardustCoinAction = new QAction(MainWindow);
        m_aboutStardustCoinAction->setObjectName(QStringLiteral("m_aboutStardustCoinAction"));
        m_aboutStardustCoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutStardustCoinAction);
        ...
        QObject::connect(m_aboutStardustCoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutStardustCoinAction->setText(QApplication::translate("MainWindow", "About StardustCoin", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND StardustCOIN", 0));
